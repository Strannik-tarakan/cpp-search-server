...
using namespace std;//Èíà÷å ÿíäåêñ íå ïðèíèìàåò(ìîæíî óáðàòü)!!!
...
public:
    ...
    explicit SearchServer(const Ñollection& stop_words);
...
template <typename Ñollection>
void SearchServer::CheckValidWord(const Ñollection& words) {
